<template>
  <div>
    ...
    <section class="section mt-3 my-lg-8">
      <div class="container px-0 px-md-1">
        <div class="row">
          <div class="col-lg-6 text-center text-light">
            <div class="bg-cover section-image-news mb-4" style="background-image: url(https://images.unsplash.com/photo-1504855328839-2f4baf9e0fd7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1291&q=80)">
              <div class="row justify-content-center">
                <div class="col-8 bg-primary-opacity py-3">
                  <h3 class="mb-3">草莓慕斯</h3>
                  <p class="h3">$420</p>
                </div>
              </div>
            </div>
            <div class="mb-4 mb-lg-0 p-5 bg-primary">
              <div class="border p-5">
                <h3 class="mb-3">新品上市</h3>
                <router-link to="/shopping" class="btn btn-minor text-primary"> 前往選購 </router-link>
              </div>
            </div>
          </div>
          <div class="col-lg-6 d-lg-flex flex-lg-column-reverse text-center text-light">
            <div class="bg-cover section-image-news mb-4 mb-lg-0" style="background-image: url(https://images.unsplash.com/photo-1505976378723-9726b54e9bb9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1234&q=80)">
              <div class="row justify-content-center">
                <div class="col-8 bg-primary-opacity py-3">
                  <h3 class="mb-3">綜合野莓蛋糕</h3>
                  <p class="h3">$320</p>
                </div>
              </div>
            </div>
            <div class="mb-4 p-5 bg-primary">
              <div class="border p-5">
                <h3 class="mb-3">本日精選</h3>
                <router-link to="/shopping" class="btn btn-minor text-primary"> 前往選購 </router-link>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 section-vt-content d-flex justify-content-end">
              <div class="text-primary-100 writing-lg-vertical py-5 py-lg-7 mr-auto">
                <p class="mb-0 mr-lg-7 ml-lg-6">青山依舊在，幾度夕陽紅。慣看秋月春風。一壺濁酒喜相逢，浪花淘盡英雄。
    ...
    <section class="text-center my-5 mb-lg-8">
      ...
      class="img-fluid d-none d-lg-inline-block" width="88" alt="">
    </section>
  </div>
</template>
