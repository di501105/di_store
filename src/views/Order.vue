        ...
        <div class="col-lg-7 p-0 px-lg-1">
            <div class="pb-0 pb-md-7">
              <form @submit.prevent="payOrder">
                  ...
                  <div class="form-row mb-5">
                    ...
                    <div class="col-6 d-flex align-items-center">
                      <div class="process-step w-100">
                        ...
                        <div class="step-circle material-icons"
                        :class="{'completed': order.is_paid, 'active': !order.is_paid}">
                          <div v-if=" order.is_paid">done</div>
                        </div>
                        <div class="step-circle material-icons"
                        :class="{'completed': order.is_paid}">
                          <div v-if=" order.is_paid">done</div>
                        </div>
                      </div>
                    </div>
                ...
                font-weight-bold py-3" v-if="order.is_paid === false">確認付款去</button>
                <router-link to="/" class="btn btn-minor btn-block btn-xl text-primary
                font-weight-bold py-3" v-else>繼續購物</router-link>
              </form>
